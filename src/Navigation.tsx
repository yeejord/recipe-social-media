...
export default function Navigation() {
    return (
        <div id="rs-navigation" 
            ...
            <Link to="/Feed" id="rs-feed-link"
                className="list-group-item text-center border-0 bg-black text-white">
                    Feed
                </Link>
            <Link to="/Profile" id="rs-profile-link"
                className="list-group-item text-center border-0 bg-black text-white">
                    Profile
                </Link>
            <Link to="/NewRecipe" id="rs-new-recipe-link"
                className="list-group-item text-center border-0 bg-black text-white">
                    New Recipe
                </Link>
            <Link to="/Signin" id="rs-sign-out-link"
                className="list-group-item text-center border-0 bg-black text-white">
                    Sign Out
                </Link>
        </div>
