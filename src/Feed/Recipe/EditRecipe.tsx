    ...
    return (
        <div id="rs-new-recipe">
          ...
          <div className="d-flex float-end">
            <Button onClick={handleUpdateRecipe} className="btn-primary border-0 me-1">Update</Button>
            <Button className="bg-danger text-white border border-0 me-1">Cancel</Button>
          </div>
        </div>
    )
};